...
**Note: You may notice that my search rates are higher than the investigation found.  I don't currently know the source of the difference, but it may be a difference of methods, data source, or both. My current theory is that a `null` value in the `personSearch` and `vehicleSearch` columns was interpreted as no search occurring by the MDOH.**
...
![Screen Shot 2021-11-23 at 7.35.40 PM.png|300](https://cdn.hashnode.com/res/hashnode/image/upload/v1651434477921/tttq8-CS_.png "Overview of each of the columns in the Open Minneapolis Police Stop data set")
...
_The original audience of my Georgia Tech Peers had an understanding of what ROC AUC was. To learn more about this useful and common machine learn metrics, see [here](https://developers.google.com/machine-learning/crash-course/classification/roc-and-auc)._
### Logistic Regression
